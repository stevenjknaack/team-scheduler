...
def test_index_route(client_and_app):
...
def test_login_get(client_and_app):
    client, app=client_and_app 
...
def test_login_post(client_and_app):
    client, app = client_and_app
...
def test_signup_get(client_and_app):
    client, app=client_and_app
...
# # Test the logout
def test_logout(client_and_app):
    client, app = client_and_app
